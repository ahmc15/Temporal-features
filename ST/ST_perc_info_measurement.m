...
function [SI, TI, index] = ST_perc_info_measurement(video_name, summary_type)
...
%Get index vector
framesForProcessing=ceil(nframes/10);
index=zeros(framesForProcessing,1);
k=1;
for n=1:framesForProcessing
    index(n)=k;
    k=k+10;
end
